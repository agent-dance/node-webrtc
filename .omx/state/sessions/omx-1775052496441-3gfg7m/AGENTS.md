...
<!-- OMX:RUNTIME:START -->
<session_context>
**Session:** omx-1775052496441-3gfg7m | 2026-04-01T14:08:19.984Z

**Codebase Map:**
  apps/: bench-receiver, bench-sender, bench, candidate-buffer, peer-manager, scenario1-multi-file, scenario2-large-file, scenario3-snake, scenario4-video
  features/: protocol-steps, protocol-steps, webrtc-steps, webrtc-steps
  packages/: dtls.test, certificate, crypto, handshake, record, state, transport, types, vitest.config
